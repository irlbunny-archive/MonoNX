...
namespace MonoNX.Graphics.Gal.OpenGL
{
    public class OpenGLRenderer : IGalRenderer
    {
        ...
        public void Render()
        {
            for (int Index = 0; Index < VertexBuffers.Count; Index++)
            {
                    ...
                    Vb.PrimCount != 0)
                {
                    ...
                    GL.DrawArrays(BeginMode.TriangleStrip, 0, Vb.PrimCount);
                }
            }
        ...
        private void EnsureVbInitialized(int VbIndex)
        {
            ...
            if (Vb.VaoHandle == 0)
            {
                GL.GenVertexArrays(1, out Vb.VaoHandle);
            }

            if (Vb.VboHandle == 0)
            {
                GL.GenBuffers(1, out Vb.VboHandle);
            }
